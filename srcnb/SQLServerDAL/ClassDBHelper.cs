...
{
    public partial class ClassDBHelper : IClassDB
    {
        #region 【得到数据库总记录数】
        /// <summary>
        /// 获取记录总数
        ...
        public int GetRecordCount(string strWhere)
        {
            ...
            strSql.Append("select count(1) FROM ClassDB ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from ClassDB ");
        ...
        public Model.ClassDB GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,classname,addate from ClassDB ");
            ...
            Model.ClassDB model = new Model.ClassDB();
